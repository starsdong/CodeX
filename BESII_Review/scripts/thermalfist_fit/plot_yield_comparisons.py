#!/usr/bin/env python3
"""Make per-energy bar plots comparing experimental yields to ThermalFIST fitted yields."""
...
def main():
    parser = argparse.ArgumentParser(description="Plot per-energy yield comparison bars.")
    parser.add_argument("--points-dir", default="data/thermalfist_fit_points")
    parser.add_argument("--outdir", default="data/thermalfist_figures/yield_comparisons")
    parser.add_argument("--fit-summary", default="data/thermalfist_fit_results.csv")
