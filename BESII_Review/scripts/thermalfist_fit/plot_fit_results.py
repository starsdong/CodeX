#!/usr/bin/env python3
"""Plot ThermalFIST fit parameters vs energy and T vs muB."""
...
def main():
    parser = argparse.ArgumentParser(description="Plot ThermalFIST fit results.")
    parser.add_argument("--input", default="data/thermalfist_fit_results.csv")
    parser.add_argument("--outdir", default="data/thermalfist_figures")
